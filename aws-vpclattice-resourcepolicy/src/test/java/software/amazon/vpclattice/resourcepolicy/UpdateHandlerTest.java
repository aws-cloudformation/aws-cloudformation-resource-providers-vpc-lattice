...
public class UpdateHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        mockSdkReturn(PutResourcePolicyResponse.builder()
                .build());

        mockSdkReturn(getResourcePolicy(UPDATED_POLICY));
        ...
        assertThat(response.getResourceModel().getResourceArn()).isEqualTo(RESOURCE_ARN);
