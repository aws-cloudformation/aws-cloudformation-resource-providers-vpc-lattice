...
public class ListHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        mockSdkReturn(ListAccessLogSubscriptionsResponse.builder()
    ...
    private List<AccessLogSubscriptionSummary> getSummaries(final int numSummaries) {
        return IntStream
                .range(0, numSummaries)
                .mapToObj(
                        (i) -> AccessLogSubscriptionSummary.builder()
                                .arn("service/svc-" + i)
                                .build()
                )
    ...
    private List<ResourceModel> toResourceModels(@Nonnull final List<AccessLogSubscriptionSummary> summaries) {
        return summaries
                .stream()
