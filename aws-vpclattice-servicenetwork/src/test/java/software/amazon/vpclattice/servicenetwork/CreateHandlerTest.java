...
public class CreateHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        mockSdkReturn(createServiceNetwork());
        ...
        AssertionsForClassTypes.assertThat(response.getResourceModel().getArn()).isEqualTo(SERVICE_NETWORK_ARN);
    }
    ...
    private static CreateServiceNetworkResponse createServiceNetwork() {
        return CreateServiceNetworkResponse.builder()
