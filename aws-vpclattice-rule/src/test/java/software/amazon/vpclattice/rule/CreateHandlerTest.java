...
public class CreateHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        AssertionsForClassTypes.assertThat(response.getResourceModel().getArn()).isEqualTo(RULE_ARN);
    }
    ...
    private static CreateRuleResponse createRule() {
