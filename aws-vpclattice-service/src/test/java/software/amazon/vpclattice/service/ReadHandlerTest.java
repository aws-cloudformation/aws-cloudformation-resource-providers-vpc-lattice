...
public class ReadHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        assertThat(model.getId()).isEqualTo(SERVICE_ID);
        assertThat(model.getArn()).isEqualTo(SERVICE_ARN);
        assertThat(model.getCreatedAt()).isNotNull();
        assertThat(model.getStatus())
                .isEqualTo(ServiceStatus.ACTIVE.toString());

        assertThat(model.getAuthType()).isEqualTo(AuthType.NONE.name());
