...
public class CreateHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        mockSdkReturn(createServiceNetworkVpcAssociation(ServiceNetworkVpcAssociationStatus.CREATE_IN_PROGRESS));
        mockSdkReturn(getServiceNetworkVpcAssociation(ServiceNetworkVpcAssociationStatus.CREATE_IN_PROGRESS), getServiceNetworkVpcAssociation());
        ...
        AssertionsForClassTypes.assertThat(response.getResourceModel().getArn()).isEqualTo(SERVICE_NETWORK_VPC_ASSOCIATION_ARN);
    }
    ...
    public void handleRequest_pollingStatusCreateFailed_throwNotStabilizedException() {
        ...
        mockSdkReturn(createServiceNetworkVpcAssociation(ServiceNetworkVpcAssociationStatus.CREATE_IN_PROGRESS));
        mockSdkReturn(getServiceNetworkVpcAssociation(ServiceNetworkVpcAssociationStatus.CREATE_FAILED));
    ...
    private static CreateServiceNetworkVpcAssociationResponse createServiceNetworkVpcAssociation(ServiceNetworkVpcAssociationStatus status) {
        return CreateServiceNetworkVpcAssociationResponse.builder()
