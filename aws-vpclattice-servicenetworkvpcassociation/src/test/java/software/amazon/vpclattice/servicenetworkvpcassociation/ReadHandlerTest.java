...
public class ReadHandlerTest extends BaseTest {
    ...
    public void handleRequest_allApiCallsSuccess_successEvent() {
        ...
        assertThat(model.getVpcIdentifier()).isNull();

        assertThat(model.getId()).isEqualTo(SERVICE_NETWORK_VPC_ASSOCIATION_ID);
        assertThat(model.getArn()).isEqualTo(SERVICE_NETWORK_VPC_ASSOCIATION_ARN);
        assertThat(model.getCreatedAt()).isNotNull();
        assertThat(model.getStatus())
                .isEqualTo(ServiceNetworkVpcAssociationStatus.ACTIVE.toString());
        ...
        assertThat(model.getVpcId()).isEqualTo(VPC_ID);
